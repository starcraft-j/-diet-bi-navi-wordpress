...
<div class="searchbox">
   ...
   <div class="seachinnerbox">
     <form role="search" method="get" id="searchform" action="<?php echo home_url( '/' ); ?>" >
       ...
       <label id="cm1"><input class="checkbox" type="checkbox" name="rules[]" value="安心の成分"><span class="checkbox1"></span></label>
       <label id="cm2"><input class="checkbox" type="checkbox" name="rules[]" value="長く続けやすい"><span class="checkbox2"></span></label>
     ...
     <div style="clear:both"></div>
       ...
       <div class="selectbox">
         <select name="jenre2">
         <option style="color:#000;" value="">実感できるまで</option>
